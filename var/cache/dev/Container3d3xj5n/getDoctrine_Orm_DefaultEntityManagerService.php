...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\ProduitBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')]);
...
$a->setEntityNamespaces(['ProduitBundle' => 'ProduitBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity']);
